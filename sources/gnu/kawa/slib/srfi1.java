...
public class srfi1 extends ModuleBody {
    ...
    /* renamed from: break */
    public static final ModuleMethod f99break;
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda19recur(Object lists) {
            ...
            return Scheme.apply.apply2(this.f34f, srfi1.append$Ex$V(new Object[]{lists, LList.list1(lambda19recur(cdrs))}));
        }

        public Object lambda20recur(Object lis) {
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f34f.apply2(lis, lambda20recur(lists.cdr.apply1(lis)));
        }
    }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object head, Object lis) {
            if (lists.isPair(lis)) {
                return this.f35f.apply2(head, lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis)));
            }
            return head;
        }
    }
    ...
    public class frame12 extends ModuleBody {
        ...
        void lambda22(Object pair) {
            try {
                lists.setCar$Ex((Pair) pair, this.f36f.apply1(lists.car.apply1(pair)));
    ...
    public class frame14 extends ModuleBody {
        ...
        Object lambda25(Object cars, Object cdrs) {
            ...
            Boolean head = Scheme.apply.apply2(this.staticLink.f37f, cars);
    ...
    public class frame18 extends ModuleBody {
        ...
        boolean lambda29(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f39x, y) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame31 extends ModuleBody {
        ...
        Object lambda46(Object heads, Object tails) {
            ...
            if (!x) {
                ...
                return this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.f40n, srfi1.Lit1));
            }
        }
    ...
    public class frame40 extends ModuleBody {
        ...
        Object lambda57(Object lis) {
            return lists.member(this.f42x, lis, this.staticLink.$Eq);
        }
    ...
    public class frame44 extends ModuleBody {
        ...
        boolean lambda61(Object lis) {
            return ((lists.member(this.f44x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame46 extends ModuleBody {
        ...
        Object lambda63() {
            return srfi1.lsetDiff$PlIntersection$V(this.staticLink.$Eq, this.f45a, new Object[]{this.f46b});
        }
        ...
        Object lambda64(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$V(this.staticLink.$Eq, this.f46b, new Object[]{this.f45a});
            } else if (!lists.isNull(frame47.a$Mnint$Mnb)) {
                return srfi1.fold$V(frame47.lambda$Fn48, a$Mnb, this.f46b, new Object[0]);
            } else {
                return append.append$V(new Object[]{this.f46b, this.f45a});
            }
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        Object lambda67() {
            return srfi1.lsetDiff$PlIntersection$Ex$V(this.staticLink.$Eq, this.f47a, new Object[]{this.f48b});
        }
        ...
        Object lambda68(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.f48b, new Object[]{this.f47a});
            } else if (!lists.isNull(frame50.a$Mnint$Mnb)) {
                return srfi1.pairFold$V(frame50.lambda$Fn52, a$Mnb, this.f48b, new Object[0]);
            } else {
                return srfi1.append$Ex$V(new Object[]{this.f48b, this.f47a});
            }
        }
    ...
    public class frame66 extends ModuleBody {
        ...
        Object lambda91(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f51a, cars), lists.cons(this.f52d, cdrs));
        }
    ...
    public class frame70 extends ModuleBody {
        ...
        Object lambda98(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f53a, cars), lists.cons(this.f54d, cdrs));
        }
    ...
    static {
        ...
        f99break = new ModuleMethod(moduleBody, 164, Lit80, 8194);
        ...
        lset$Mnintersection = new ModuleMethod(moduleBody, YaVersion.YOUNG_ANDROID_VERSION, Lit92, -4094);
    ...
    public static Object map$Ex$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        if (lists.isPair(lists)) {
            ...
            while (isNullList(lis12) == Boolean.FALSE) {
                ...
                try {
                    lists.setCar$Ex((Pair) lis12, Scheme.apply.apply3(frame12.f36f, lists.car.apply1(lis12), heads));
    ...
    public static Object filterMap$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Boolean head = frame13.f37f.apply1(lists.car.apply1(lis));
            Object tail = lists.cdr.apply1(lis);
            if (head != Boolean.FALSE) {
    ...
    /* renamed from: break */
    public static Object m50break(Object pred, Object lis) {
