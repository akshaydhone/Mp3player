...
public class srfi13 extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        Object lambda3() {
            return srfi13.stringParseStart$PlEnd(this.proc, this.f55s, this.args);
        }
    ...
    public class frame10 extends ModuleBody {
        ...
        Object lambda25() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnany, this.f56s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        Object lambda7() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncopy, this.f57s, this.maybe$Mnstart$Plend);
        }

        CharSequence lambda8(Object start, Object end) {
            Object obj = this.f57s;
            try {
                try {
                    try {
    ...
    public class frame3 extends ModuleBody {
        ...
        Object lambda9() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap, this.f58s, this.maybe$Mnstart$Plend);
        }

        Object lambda10(Object start, Object end) {
            return srfi13.$PcStringMap(this.proc, this.f58s, start, end);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda11() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap$Ex, this.f59s, this.maybe$Mnstart$Plend);
        }

        Object lambda12(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(this.proc, this.f59s, start, end);
        }
    }
    ...
    public class frame56 extends ModuleBody {
        ...
        Object lambda134() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash, this.f60s, srfi13.loc$rest.get());
        ...
        Object lambda135(Object start, Object end) {
            return srfi13.$PcStringHash(this.f60s, characters.char$Mn$Grinteger, this.bound, start, end);
        }
    }
    ...
    public class frame57 extends ModuleBody {
        ...
        Object lambda136() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash$Mnci, this.f61s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda137(Object start, Object end) {
            return srfi13.$PcStringHash(this.f61s, srfi13.lambda$Fn138, this.bound, start, end);
        }
    }
    ...
    public class frame58 extends ModuleBody {
        ...
        Object lambda139() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase, this.f62s, this.maybe$Mnstart$Plend);
        }

        Object lambda140(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mnupcase, this.f62s, start, end);
        }
    }
    ...
    public class frame59 extends ModuleBody {
        ...
        Object lambda141() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase$Ex, this.f63s, this.maybe$Mnstart$Plend);
        }

        Object lambda142(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mnupcase, this.f63s, start, end);
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        Object lambda13() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold, this.f64s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame60 extends ModuleBody {
        ...
        Object lambda143() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase, this.f65s, this.maybe$Mnstart$Plend);
        }

        Object lambda144(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mndowncase, this.f65s, start, end);
        }
    }
    ...
    public class frame61 extends ModuleBody {
        ...
        Object lambda145() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase$Ex, this.f66s, this.maybe$Mnstart$Plend);
        }

        Object lambda146(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mndowncase, this.f66s, start, end);
        }
    }
    ...
    public class frame62 extends ModuleBody {
        ...
        Object lambda148(Object start, Object end) {
            return srfi13.$PcStringTitlecase$Ex(this.f67s, start, end);
        }
    }
    ...
    public class frame63 extends ModuleBody {
        ...
        Object lambda149() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntitlecase$Ex, this.f68s, this.maybe$Mnstart$Plend);
        }

        CharSequence lambda150(Object start, Object end) {
            Object obj = this.f68s;
            try {
                try {
                    try {
    ...
    public class frame67 extends ModuleBody {
        ...
        boolean lambda154(Object val) {
            boolean x = numbers.isInteger(this.f73n);
            if (!x) {
                return x;
            }
            x = numbers.isExact(this.f73n);
            return x ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f73n, Integer.valueOf(this.len))).booleanValue() : x;
        }
    ...
    public class frame68 extends ModuleBody {
        ...
        Object lambda155() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim, this.f74s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda156(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkip$V(this.f74s, srfi13.loc$criterion.get(), new Object[]{start, end});
    ...
    public class frame69 extends ModuleBody {
        ...
        Object lambda157() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnright, this.f75s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda158(Object start, Object end) {
            try {
                Boolean temp = srfi13.stringSkipRight$V(this.f75s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
    ...
    public class frame6 extends ModuleBody {
        ...
        Object lambda15() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold$Mnright, this.f76s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame70 extends ModuleBody {
        ...
        Object lambda159() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnboth, this.f77s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda160(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkip$V(this.f77s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            Object apply2 = AddOp.$Pl.apply2(srfi13.Lit1, srfi13.stringSkipRight$V(this.f77s, srfi13.loc$criterion.get(), new Object[]{temp, end}));
                            try {
    ...
    public class frame71 extends ModuleBody {
        ...
        Object lambda161() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad$Mnright, this.f79s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda162(Object start, Object end) {
            Object obj;
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn163, this.f78n, srfi13.string$Mnpad$Mnright);
                if (Scheme.numLEq.apply2(this.f78n, AddOp.$Mn.apply2(end, start)) != Boolean.FALSE) {
                    obj = this.f79s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        try {
                            int intValue = ((Number) start).intValue();
                            Object apply2 = AddOp.$Pl.apply2(start, this.f78n);
                            try {
                                return srfi13.$PcSubstring$SlShared(charSequence, intValue, ((Number) apply2).intValue());
                            } catch (ClassCastException e) {
                                throw new WrongType(e, "%substring/shared", 2, apply2);
    ...
    public class frame72 extends ModuleBody {
        ...
        Object lambda164() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad, this.f81s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda165(Object start, Object end) {
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn166, this.f80n, srfi13.string$Mnpad);
                Object len = AddOp.$Mn.apply2(end, start);
                Object obj;
                if (Scheme.numLEq.apply2(this.f80n, len) != Boolean.FALSE) {
                    obj = this.f81s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        Object apply2 = AddOp.$Mn.apply2(end, this.f80n);
                        try {
                            try {
                ...
                Object obj2 = this.f80n;
                try {
                    Object ans = strings.makeString(((Number) obj2).intValue(), LangPrimType.charType);
                    obj2 = AddOp.$Mn.apply2(this.f80n, len);
                    try {
                        int intValue = ((Number) obj2).intValue();
                        obj = this.f81s;
                        try {
    ...
    public class frame73 extends ModuleBody {
        ...
        Object lambda167() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndelete, this.f82s, this.maybe$Mnstart$Plend);
        }
        ...
        CharSequence lambda168(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame74.lambda$Fn169, srfi13.Lit0, this.f82s, new Object[]{start, end});
            ...
            try {
                ...
                frame74.cset = obj;
                Object len = srfi13.stringFold$V(frame74.lambda$Fn170, srfi13.Lit0, this.f82s, new Object[]{start, end});
                try {
                    frame74.ans = strings.makeString(((Number) len).intValue());
                    srfi13.stringFold$V(frame74.lambda$Fn171, srfi13.Lit0, this.f82s, new Object[]{start, end});
                    return frame74.ans;
                } catch (ClassCastException e22) {
    ...
    public class frame75 extends ModuleBody {
        ...
        Object lambda172() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfilter, this.f83s, this.maybe$Mnstart$Plend);
        }
        ...
        CharSequence lambda173(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame76.lambda$Fn174, srfi13.Lit0, this.f83s, new Object[]{start, end});
                    if (Scheme.numEqu.apply2(ans$Mnlen, slen) != Boolean.FALSE) {
                        return frame76.temp;
                    }
                    try {
            ...
            try {
                ...
                frame76.cset = obj;
                Object len = srfi13.stringFold$V(frame76.lambda$Fn175, srfi13.Lit0, this.f83s, new Object[]{start, end});
                try {
                    frame76.ans = strings.makeString(((Number) len).intValue());
                    srfi13.stringFold$V(frame76.lambda$Fn176, srfi13.Lit0, this.f83s, new Object[]{start, end});
                    return frame76.ans;
                } catch (ClassCastException e22) {
                    throw new WrongType(e22, "make-string", 1, len);
                }
    ...
    public class frame7 extends ModuleBody {
        ...
        Object lambda19() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach, this.f84s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame81 extends ModuleBody {
        ...
        Object lambda185() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncount, this.f85s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame82 extends ModuleBody {
        ...
        Object lambda187() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfill$Ex, this.f87s, this.maybe$Mnstart$Plend);
        }
        ...
        Object lambda188(Object start, Object end) {
            ...
            while (Scheme.numLss.apply2(i, start) == Boolean.FALSE) {
                Object obj = this.f87s;
                try {
                    CharSeq charSeq = (CharSeq) obj;
                    try {
                        int intValue = ((Number) i).intValue();
                        Object obj2 = this.f86char;
                        try {
    ...
    public class frame88 extends ModuleBody {
        ...
        public frame88() {
            ...
            moduleMethod = new ModuleMethod(this, YaVersion.YOUNG_ANDROID_VERSION, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        Object lambda198(Object args) {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnkmp$Mnpartial$Mnsearch, this.f88s, args);
        }
    ...
    public class frame89 extends ModuleBody {
        ...
        Object lambda200() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse, this.f89s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame8 extends ModuleBody {
        ...
        Object lambda21() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach$Mnindex, this.f90s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame90 extends ModuleBody {
        ...
        Object lambda202() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse$Ex, this.f91s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame91 extends ModuleBody {
        ...
        Object lambda204() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mn$Grlist, this.f92s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame93 extends ModuleBody {
        ...
        Object lambda208() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntokenize, this.f93s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        Object lambda209(Object start, Object end) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (x) {
                        try {
                            temp = srfi13.stringIndexRight$V(this.f93s, srfi13.loc$token$Mnchars.get(), new Object[]{start, i});
                        } catch (UnboundLocationException e) {
                    ...
                    try {
                        temp = srfi13.stringSkipRight$V(this.f93s, srfi13.loc$token$Mnchars.get(), new Object[]{start, temp});
                        if (temp != Boolean.FALSE) {
                            obj = this.f93s;
                            try {
                                CharSequence charSequence = (CharSequence) obj;
    ...
    public class frame94 extends ModuleBody {
            ...
            try {
                ...
                try {
                    if (numbers.isZero((Number) slen)) {
                        return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.xsubstring, this.f94s, this.from, to, start, end});
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    srfi13.$PcMultispanRepcopy$Ex(ans, srfi13.Lit0, this.f94s, this.from, to, start, end);
                                    return ans;
                                } catch (ClassCastException e3222) {
        ...
        Object lambda211() {
            ...
            try {
                Object apply4 = Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), strings.string$Qu, this.f94s, srfi13.xsubstring);
                try {
        ...
        Object lambda212() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.xsubstring, this.f94s, lists.cdr.apply1(this.maybe$Mnto$Plstart$Plend));
        }
    ...
    public class frame95 extends ModuleBody {
        ...
        Object lambda221(Object sto, Object start, Object end) {
            ...
            try {
                ...
                if (!x) {
                    try {
                        if (numbers.isZero((Number) slen)) {
                            return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.string$Mnxcopy$Ex, this.target, this.tstart, this.f95s, this.sfrom, sto, start, end});
                        } else if (Scheme.numEqu.apply2(srfi13.Lit1, slen) != Boolean.FALSE) {
                            r4 = this.target;
                            r2 = this.f95s;
                            try {
                            ...
                            try {
                                ...
                                try {
                                    if (doubleValue != numbers.floor(LangObjType.coerceRealNum(r4)).doubleValue()) {
                                        return srfi13.$PcMultispanRepcopy$Ex(this.target, this.tstart, this.f95s, this.sfrom, sto, start, end);
                                    }
                                    r2 = this.target;
                                    try {
        ...
        Object lambda218() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnxcopy$Ex, this.f95s, lists.cdr.apply1(this.maybe$Mnsto$Plstart$Plend));
        }
    ...
    public class frame9 extends ModuleBody {
        ...
        Object lambda23() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnevery, this.f97s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame extends ModuleBody {
        ...
        Object lambda2(Object end, Object args) {
            ...
            return misc.error$V("Illegal substring START/END spec", new Object[]{this.proc, this.start, end, this.f98s});
        }
        ...
        Object lambda1() {
            if (lists.isPair(this.args)) {
                ...
                if (x) {
                    ...
                    return misc.error$V("Illegal substring END spec", new Object[]{this.proc, end, this.f98s});
                }
    ...
    static {
        ...
        substring$Slshared = new ModuleMethod(moduleBody, 200, Lit50, -4094);
        $Pcsubstring$Slshared = new ModuleMethod(moduleBody, 201, Lit51, 12291);
        string$Mncopy = new ModuleMethod(moduleBody, 202, Lit52, -4095);
        string$Mnmap = new ModuleMethod(moduleBody, HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, Lit53, -4094);
        $Pcstring$Mnmap = new ModuleMethod(moduleBody, HttpStatus.SC_NO_CONTENT, Lit54, 16388);
        string$Mnmap$Ex = new ModuleMethod(moduleBody, HttpStatus.SC_RESET_CONTENT, Lit55, -4094);
        $Pcstring$Mnmap$Ex = new ModuleMethod(moduleBody, HttpStatus.SC_PARTIAL_CONTENT, Lit56, 16388);
        string$Mnfold = new ModuleMethod(moduleBody, HttpStatus.SC_MULTI_STATUS, Lit57, -4093);
        ...
        $Pcstring$Mncopy$Ex = new ModuleMethod(moduleBody, 302, Lit126, 20485);
        string$Mncontains = new ModuleMethod(moduleBody, 303, Lit127, -4094);
        string$Mncontains$Mnci = new ModuleMethod(moduleBody, 304, Lit128, -4094);
        $Pckmp$Mnsearch = new ModuleMethod(moduleBody, 305, Lit129, 28679);
        make$Mnkmp$Mnrestart$Mnvector = new ModuleMethod(moduleBody, ErrorMessages.ERROR_TWITTER_SET_STATUS_FAILED, Lit130, -4095);
        kmp$Mnstep = new ModuleMethod(moduleBody, 307, Lit131, 24582);
        string$Mnkmp$Mnpartial$Mnsearch = new ModuleMethod(moduleBody, 308, Lit132, -4092);
    ...
    public static Object stringParseStart$PlEnd(Object proc, Object s, Object args) {
        ...
        frame.proc = proc;
        frame.f98s = s;
        if (!strings.isString(frame.f98s)) {
            misc.error$V("Non-string value", new Object[]{frame.proc, frame.f98s});
        }
        Object obj = frame.f98s;
        try {
            ...
            if (lists.isPair(args)) {
                ...
                if (x) {
                    ...
                    return misc.error$V("Illegal substring START spec", new Object[]{frame.proc, frame.start, frame.f98s});
                }
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                try {
                                                                    ...
                                                                    try {
                                                                        try {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                e4.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 416, 29);
                                                                                throw e4;
                                                                            }
                                                    ...
                                                    e42.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 402, 38);
                                                    throw e42;
                                                }
                                            ...
                                            e422.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", HttpStatus.SC_BAD_REQUEST, 20);
                                            throw e422;
                                        }
    ...
    public static Object stringUnfoldRight$V(Object p, Object f, Object g, Object seed, Object[] argsArray) {
        ...
        try {
                ...
                try {
                    try {
                        try {
                            ...
                            e4222.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", HttpStatus.SC_UNPROCESSABLE_ENTITY, 46);
                            throw e4222;
                        }
                    } catch (UnboundLocationException e42222) {
                        e42222.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", HttpStatus.SC_UNPROCESSABLE_ENTITY, 6);
                        throw e42222;
                    }
                } catch (UnboundLocationException e422222) {
            ...
            e42222222.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", HttpStatus.SC_METHOD_FAILURE, 3);
            throw e42222222;
        }
    }
    ...
    public static Object stringTake(Object s, Object n) {
        ...
        frame64.f69n = n;
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), strings.string$Qu, frame64.f70s, string$Mntake);
            try {
                Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame64.lambda$Fn151, frame64.f69n, string$Mntake);
                Object obj = frame64.f70s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
                    Object obj2 = frame64.f69n;
                    try {
    ...
    public static Object stringTakeRight(Object s, Object n) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame65.lambda$Fn152, frame65.f71n, string$Mntake$Mnright);
                    try {
                        CharSequence charSequence = (CharSequence) s;
                        Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame65.len), frame65.f71n);
                        try {
    ...
    public static Object stringDrop(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame66.lambda$Fn153, frame66.f72n, string$Mndrop);
            Object obj = frame66.f72n;
            try {
    ...
    public static Object stringDropRight(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame67.lambda$Fn154, frame67.f73n, string$Mndrop$Mnright);
            Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame67.len), frame67.f73n);
            try {
    ...
    public static Object stringFill$Ex$V(Object s, Object char_, Object[] argsArray) {
        ...
        frame82.f87s = s;
        frame82.f86char = char_;
        frame82.maybe$Mnstart$Plend = LList.makeList(argsArray, 0);
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), characters.char$Qu, frame82.f86char, string$Mnfill$Ex);
