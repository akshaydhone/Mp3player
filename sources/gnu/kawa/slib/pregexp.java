...
public class pregexp extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda5loupOneOfChars(Object chars) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame1.chars), this.f22i, this.sk, frame1.lambda$Fn13);
        }
        ...
        Object lambda10() {
            return Scheme.applyToArgs.apply2(this.sk, AddOp.$Pl.apply2(this.f22i, pregexp.Lit8));
        }
        ...
        public Object lambda7loupOr(Object res) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame3.res), this.f22i, frame3.lambda$Fn15, frame3.lambda$Fn16);
        }
        ...
        Object lambda12(Object i1) {
            ...
            try {
                lists.setCdr$Ex((Pair) assv, lists.cons(this.f22i, i1));
        ...
        public Object lambda8loupP(Object k, Object i) {
            ...
            frame4.f26k = k;
            frame4.f25i = i;
            if (Scheme.numLss.apply2(frame4.f26k, this.f23p) != Boolean.FALSE) {
                return this.staticLink.lambda3sub(this.re, frame4.f25i, frame4.lambda$Fn17, this.fk);
            }
            frame4.f27q = this.f24q != Boolean.FALSE ? AddOp.$Mn.apply2(this.f24q, this.f23p) : this.f24q;
            return frame4.lambda24loupQ(pregexp.Lit73, frame4.f25i);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda24loupQ(Object k, Object i) {
            ...
            frame5.f28i = i;
            frame5.fk = frame5.fk;
            if (this.f27q == Boolean.FALSE ? this.f27q != Boolean.FALSE : Scheme.numGEq.apply2(frame5.f29k, this.f27q) != Boolean.FALSE) {
                return frame5.lambda26fk();
            }
            if (this.staticLink.maximal$Qu) {
                return this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f28i, frame5.lambda$Fn18, frame5.fk);
            }
            Boolean x = frame5.lambda26fk();
            return x == Boolean.FALSE ? this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f28i, frame5.lambda$Fn19, frame5.fk) : x;
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda26fk() {
            return Scheme.applyToArgs.apply2(this.staticLink.staticLink.sk, this.f28i);
        }
        ...
        Object lambda28(Object i1) {
            return this.staticLink.lambda24loupQ(AddOp.$Pl.apply2(this.f29k, pregexp.Lit8), i1);
        }
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda3sub(Object re, Object i, Object sk, Object fk) {
            ...
            if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit10) != Boolean.FALSE) {
                if (Scheme.numEqu.apply2(frame0.f22i, this.start) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i);
                }
                return Scheme.applyToArgs.apply1(frame0.fk);
            } else if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit12) != Boolean.FALSE) {
                return Scheme.numGEq.apply2(frame0.f22i, this.f30n) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i) : Scheme.applyToArgs.apply1(frame0.fk);
            } else {
                ...
                if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    if (pregexp.isPregexpAtWordBoundary(this.f31s, frame0.f22i, this.f30n) != Boolean.FALSE) {
                        return Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i);
                    }
                    return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    if (x ? Scheme.numLss.apply2(frame0.f22i, this.f30n) != Boolean.FALSE : x) {
                        ...
                        try {
                            ...
                            obj2 = frame0.f22i;
                            try {
                                return procedure.apply2(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), frame0.re$1) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f22i, pregexp.Lit8)) : Scheme.applyToArgs.apply1(frame0.fk);
                            } catch (ClassCastException e) {
                    ...
                    if (x ? Scheme.numLss.apply2(frame0.f22i, this.f30n) != Boolean.FALSE : x) {
                        ...
                        try {
                            ...
                            obj2 = frame0.f22i;
                            try {
                                if (pregexp.isPregexpCheckIfInCharClass(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), frame0.re$1) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f22i, pregexp.Lit8));
                                }
                                return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    if (x3 != null) {
                        ...
                        if (lists.isPair(frame0.re$1)) {
                            ...
                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit83) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(frame0.f22i, this.f30n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(frame0.fk);
                                }
                                ...
                                return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, frame0.lambda$Fn2, frame0.lambda$Fn3);
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit5) != Boolean.FALSE) {
                                return frame0.lambda6loupSeq(lists.cdr.apply1(frame0.re$1), frame0.f22i);
                            } else {
                                ...
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj2).intValue()), this.f31s, frame0.f22i, this.f30n, frame0.lambda$Fn4, frame0.fk);
                                    ...
                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, frame0.lambda$Fn5, frame0.fk);
                                } else {
                                    if (Scheme.isEqv.apply2(tmp, pregexp.Lit103) != Boolean.FALSE) {
                                        return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, this.identity, pregexp.lambda$Fn6) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i) : Scheme.applyToArgs.apply1(frame0.fk);
                                    } else {
                                        if (Scheme.isEqv.apply2(tmp, pregexp.Lit104) != Boolean.FALSE) {
                                            return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, this.identity, pregexp.lambda$Fn7) != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i);
                                        } else {
                                            Object n$Mnactual;
                                            Object sn$Mnactual;
                                            Boolean found$Mnit$Qu;
                                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit105) != Boolean.FALSE) {
                                                n$Mnactual = this.f30n;
                                                sn$Mnactual = this.sn;
                                                this.f30n = frame0.f22i;
                                                this.sn = frame0.f22i;
                                                ...
                                                this.f30n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i) : Scheme.applyToArgs.apply1(frame0.fk);
                                                ...
                                                this.f30n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit109) != Boolean.FALSE) {
                                                found$Mnit$Qu = lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, this.identity, pregexp.lambda$Fn10);
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    ...
                                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f22i, frame0.lambda$Fn11, frame0.lambda$Fn12);
                                                } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit68) != Boolean.FALSE) {
                                                    obj = lists.cadr.apply1(frame0.re$1);
                                                    try {
                                                        boolean z;
                                                        frame0.maximal$Qu = ((obj != Boolean.FALSE ? 1 : 0) + 1) & 1;
                                                        frame0.f23p = lists.caddr.apply1(frame0.re$1);
                                                        frame0.f24q = lists.cadddr.apply1(frame0.re$1);
                                                        ...
                                                        return frame0.lambda8loupP(pregexp.Lit73, frame0.f22i);
                        ...
                        } else if (Scheme.numGEq.apply2(frame0.f22i, this.f30n) != Boolean.FALSE) {
                            return Scheme.applyToArgs.apply1(frame0.fk);
                        } else {
                            return pregexp.pregexpError$V(new Object[]{pregexp.Lit101});
                        }
                ...
                } else if (pregexp.isPregexpAtWordBoundary(this.f31s, frame0.f22i, this.f30n) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply1(frame0.fk);
                } else {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f22i);
                }
