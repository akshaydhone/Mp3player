...
public class printf extends ModuleBody {
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i, Integer.valueOf(this.staticLink.staticLink.staticLink.f33n)) != Boolean.FALSE) {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2sign(Object i, Object cont) {
            if (Scheme.numLss.apply2(i, Integer.valueOf(this.f33n)) == Boolean.FALSE) {
                return Values.empty;
            }
            Object obj = this.str;
            try {
        ...
        public Object lambda3digits(Object i, Object cont) {
            ...
            Object j = i;
            while (true) {
                Object apply2 = Scheme.numGEq.apply2(j, Integer.valueOf(this.f33n));
                try {
        ...
        Object lambda5(Object i, Object sgn, Object digs, Object ex) {
            ...
            frame0.digs = digs;
            frame0.ex = ex;
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f33n)) != Boolean.FALSE) {
    ...
    public static Object stdio$ClParseFloat(Object str, Object proc) {
        ...
        try {
            frame.f33n = strings.stringLength((CharSequence) obj);
