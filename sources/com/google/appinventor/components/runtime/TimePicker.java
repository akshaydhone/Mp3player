...
@SimpleObject
@DesignerComponent(category = ComponentCategory.USERINTERFACE, description = "<p>A button that, when clicked on, launches  a popup dialog to allow the user to select a time.</p>", docUri = "user-interface/datepicker", version = 3)
public class TimePicker extends ButtonBase {
    ...
    private OnTimeSetListener timePickerListener = new C04121();

    /* renamed from: com.google.appinventor.components.runtime.TimePicker$1 */
    class C04121 implements OnTimeSetListener {
        ...
        public void onTimeSet(android.widget.TimePicker view, int selectedHour, int selectedMinute) {
            if (view.isShown()) {
                ...
                TimePicker.this.androidUIHandler.post(new C04111());
            }
        }
    }
