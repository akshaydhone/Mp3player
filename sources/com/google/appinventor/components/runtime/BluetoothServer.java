...
@SimpleObject
@DesignerComponent(category = ComponentCategory.CONNECTIVITY, description = "Bluetooth server component", docUri = "iot/bluetooth", iconName = "images/bluetooth.png", nonVisible = true, version = 5)
                        ...
                        public void run() {
                            ...
                            if (bluetoothServerSocket != null) {
                                try {
                                    ...
                                    BluetoothServer.this.androidUIHandler.post(new C02631());
                                    return;
                                } finally {
