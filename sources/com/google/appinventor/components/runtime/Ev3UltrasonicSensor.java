...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to an ultrasonic sensor on a LEGO MINDSTORMS EV3 robot.", docUri = "iot/lego.html#ev3-ultrasonic-sensor", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
public class Ev3UltrasonicSensor extends LegoMindstormsEv3Sensor implements Deleteable {
    ...
    private final Runnable sensorValueChecker = new C02881();
