...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a touch sensor on a LEGO MINDSTORMS EV3 robot.", docUri = "iot/lego.html#ev3-touch-sensor", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
public class Ev3TouchSensor extends LegoMindstormsEv3Sensor implements Deleteable {
    ...
    private final Runnable sensorValueChecker = new C02871();
