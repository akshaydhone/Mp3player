...
@SimpleObject
@DesignerComponent(category = ComponentCategory.USERINTERFACE, description = "<p>This is a visible component that displays a list of text elements. <br> The list can be set using the ElementsFromString property or using the Elements block in the blocks editor. </p>", docUri = "user-interface/listpicker", iconName = "images/listView.png", nonVisible = false, version = 5)
public final class ListView extends AndroidViewComponent implements OnItemClickListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.ListView$1 */
    ...
    public ListView(ComponentContainer container) {
        ...
        this.txtSearchBox.addTextChangedListener(new C03451());
        if (this.showFilter) {
