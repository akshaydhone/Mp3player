...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a sound sensor on a LEGO MINDSTORMS NXT robot.", docUri = "iot/lego.html#nxt-sound-sensor", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
public class NxtSoundSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private final Runnable sensorReader = new C03771();
    private int topOfRange;
    private boolean withinRangeEventEnabled;

    /* renamed from: com.google.appinventor.components.runtime.NxtSoundSensor$1 */
