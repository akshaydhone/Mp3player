...
public final class SplashActivity extends AppInventorCompatActivity {
    ...
    class C03881 extends WebChromeClient {
        C03881() {
        }
    ...
    public class JavaInterface {
        ...
        public void finished() {
            SplashActivity.this.handler.post(new C03891());
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.webview.setWebChromeClient(new C03881());
        setContentView(this.webview);
        this.webview.addJavascriptInterface(android, Constants.PLATFORM);
