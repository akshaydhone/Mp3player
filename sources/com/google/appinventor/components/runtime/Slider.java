...
public class Slider extends AndroidViewComponent implements OnSeekBarChangeListener {
    ...
    private static final int initialLeftColor = -26624;
    private static final String initialLeftColorString = "&HFFFF9800";
    private static final int initialRightColor = -6381922;
    private static final String initialRightColorString = "&HFF9E9E9E";
    ...
    public Slider(ComponentContainer container) {
        ...
        this.leftColor = -26624;
        this.rightColor = -6381922;
        setSliderColors();
        container.$add(this);
        this.minValue = 10.0f;
        this.maxValue = 50.0f;
    ...
    public void ThumbEnabled(boolean enabled) {
        ...
        this.seekbar.setOnTouchListener(new C03841());
    }
    ...
    @DesignerProperty(defaultValue = "&HFFFF9800", editorType = "color")
    @SimpleProperty
