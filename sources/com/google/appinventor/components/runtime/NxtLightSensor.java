...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a light sensor on a LEGO MINDSTORMS NXT robot.", docUri = "iot/lego.html#nxt-light-sensor", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
public class NxtLightSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private final Runnable sensorReader = new C03761();
    private int topOfRange;
    private boolean withinRangeEventEnabled;

    /* renamed from: com.google.appinventor.components.runtime.NxtLightSensor$1 */
