...
@SimpleObject
@DesignerComponent(category = ComponentCategory.STORAGE, description = "Non-visible component that communicates with a Web service to store and retrieve information.", docUri = "storage/tiny-web-db", iconName = "images/tinyWebDB.png", nonVisible = true, version = 2)
...
public class TinyWebDB extends AndroidNonvisibleComponent implements Component {
    ...
    class C06332 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            TinyWebDB.this.androidUIHandler.post(new C04141());
        }
    ...
    private void postStoreValue(String tag, Object valueToStore) {
        AsyncCallbackPair<String> myCallback = new C06332();
        try {
    ...
    private void postGetValue(final String tag) {
        AsyncCallbackPair<JSONArray> myCallback = new AsyncCallbackPair<JSONArray>() {
            ...
            class C04193 implements Runnable {
                C04193() {
                }
            ...
            public void onSuccess(JSONArray result) {
                if (result == null) {
                    TinyWebDB.this.androidUIHandler.post(new C04171());
                    return;
                }
                try {
                    ...
                    TinyWebDB.this.androidUIHandler.post(new C04193());
                }
            }
