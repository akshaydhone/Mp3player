...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a touch sensor on a LEGO MINDSTORMS NXT robot.", docUri = "iot/lego.html#nxt-touch-sensor", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
public class NxtTouchSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private final Runnable sensorReader = new C03781();

    /* renamed from: com.google.appinventor.components.runtime.NxtTouchSensor$1 */
