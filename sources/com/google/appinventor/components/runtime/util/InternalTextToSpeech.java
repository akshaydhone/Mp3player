...
public class InternalTextToSpeech implements ITextToSpeech {
    ...
    class C04801 implements OnInitListener {
        C04801() {
        }
    ...
    class C04822 implements OnUtteranceCompletedListener {
        ...
        public void onUtteranceCompleted(String utteranceId) {
            InternalTextToSpeech.this.activity.runOnUiThread(new C04811());
        }
    }
    ...
    private void initializeTts() {
        if (this.tts == null) {
            ...
            this.tts = new TextToSpeech(this.activity, new C04801());
        }
    }
    ...
    private void speak(final String message, final Locale loc, final int retries) {
        ...
        if (this.isTtsInitialized) {
            ...
            this.tts.setOnUtteranceCompletedListener(new C04822());
