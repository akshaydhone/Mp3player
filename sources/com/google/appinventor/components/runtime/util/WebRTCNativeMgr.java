...
public class WebRTCNativeMgr {
    ...
    Observer dataObserver = new C05043();
    private boolean first = true;
    private ReplForm form;
    private boolean haveOffer = false;
    private volatile boolean keepPolling = true;
    PeerConnection.Observer observer = new C05032();
    private PeerConnection peerConnection;
    private String rCode;
    private Random random = new Random();
    private String rendezvousServer = "rendezvous.appinventor.mit.edu";
    SdpObserver sdpObserver = new C05021();
    ...
    class C05021 implements SdpObserver {
        C05021() {
        }
    ...
    class C05032 implements PeerConnection.Observer {
        C05032() {
        }
    ...
    class C05043 implements Observer {
        C05043() {
        }
    ...
    class C05064 implements Runnable {
        ...
        class C05051 extends TimerTask {
            C05051() {
            }
        ...
        public void run() {
            try {
                ...
                if (WebRTCNativeMgr.this.keepPolling) {
                    ...
                    if (WebRTCNativeMgr.this.keepPolling) {
                        WebRTCNativeMgr.this.timer.schedule(new C05051(), 1000);
                        return;
                    }
                    return;
                }
    ...
    private void Poller() {
        this.background.submit(new C05064());
    }
