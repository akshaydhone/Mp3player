...
class NativeOpenStreetMapController implements MapController, MapListener {
    ...
    class C04891 implements OnTapListener {
        C04891() {
        }
    ...
    class C04902 implements OnPreDrawListener {
        C04902() {
        }
            ...
            switch (msg.what) {
                case 0:
                    if (!NativeOpenStreetMapController.this.ready && NativeOpenStreetMapController.this.form.canDispatchEvent(null, "MapReady")) {
                        ...
                        NativeOpenStreetMapController.this.form.runOnUiThread(new C04991());
                    }
    ...
    NativeOpenStreetMapController(Form form) {
        ...
        this.view.addOnTapListener(new C04891());
    ...
    public void setCompassEnabled(boolean enabled) {
        if (enabled && this.compass == null) {
            ...
            this.view.getViewTreeObserver().addOnPreDrawListener(new C04902());
    ...
    public void addFeature(final MapMarker aiMarker) {
        createNativeMarker(aiMarker, new AsyncCallbackPair<Marker>() {
            ...
            class C04911 implements OnMarkerClickListener {
                C04911() {
                }
            ...
            class C04922 implements OnMarkerDragListener {
                C04922() {
                }
            ...
            public void onSuccess(Marker overlay) {
                overlay.setOnMarkerClickListener(new C04911());
                overlay.setOnMarkerDragListener(new C04922());
                if (aiMarker.Visible()) {
