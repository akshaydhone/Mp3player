...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides both high- and low-level interfaces to a LEGO MINDSTORMS EV3 robot, with functions that can control the motors.", docUri = "iot/lego.html#ev3-motors", iconName = "images/legoMindstormsEv3.png", nonVisible = true, version = 1)
public class Ev3Motors extends LegoMindstormsEv3Base {
    ...
    private final Runnable sensorValueChecker = new C02861();
    ...
    /* renamed from: com.google.appinventor.components.runtime.Ev3Motors$1 */
