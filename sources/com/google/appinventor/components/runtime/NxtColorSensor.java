...
@SimpleObject
@DesignerComponent(category = ComponentCategory.LEGOMINDSTORMS, description = "A component that provides a high-level interface to a color sensor on a LEGO MINDSTORMS NXT robot.", docUri = "iot/lego.html#nxt-color-sensor", iconName = "images/legoMindstormsNxt.png", nonVisible = true, version = 1)
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private final Runnable sensorReader = new C03751();
    private int topOfRange;
    private boolean withinRangeEventEnabled;

    /* renamed from: com.google.appinventor.components.runtime.NxtColorSensor$1 */
