...
public class DatePicker extends ButtonBase {
    ...
    private OnDateSetListener datePickerListener = new C02811();
    private int day;
    private Form form;
    ...
    /* renamed from: com.google.appinventor.components.runtime.DatePicker$1 */
    class C02811 implements OnDateSetListener {

        /* renamed from: com.google.appinventor.components.runtime.DatePicker$1$1 */
        ...
        public void onDateSet(android.widget.DatePicker datePicker, int selectedYear, int selectedMonth, int selectedDay) {
            if (datePicker.isShown()) {
                ...
                DatePicker.this.androidUIHandler.post(new C02801());
            }
        }
    }
