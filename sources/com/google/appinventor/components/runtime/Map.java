...
public class Map extends MapFeatureContainerBase implements MapEventListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.Map$2 */
    ...
    /* renamed from: com.google.appinventor.components.runtime.Map$3 */
    ...
    /* renamed from: com.google.appinventor.components.runtime.Map$4 */
    class C03524 implements Runnable {
        C03524() {
        }
    ...
    public void onReady(MapController map) {
        this.container.$form().runOnUiThread(new C03502());
    }

    public void onBoundsChanged() {
        this.container.$form().runOnUiThread(new C03513());
    }

    public void onZoom() {
        this.container.$form().runOnUiThread(new C03524());
    }
