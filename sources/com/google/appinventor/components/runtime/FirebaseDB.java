...
@DesignerComponent(androidMinSdk = 10, category = ComponentCategory.EXPERIMENTAL, description = "Non-visible component that communicates with Firebase to store and retrieve information.", designerHelpDescription = "Non-visible component that communicates with a Firebase to store and retrieve information.", docUri = "storage/firebase-db", iconName = "images/firebaseDB.png", nonVisible = true, version = 3)
...
public class FirebaseDB extends AndroidNonvisibleComponent implements Component {
    ...
    class C02971 implements ChildEventListener {
        C02971() {
        }
    ...
    class C02992 implements AuthStateListener {

        /* renamed from: com.google.appinventor.components.runtime.FirebaseDB$2$1 */
        class C02981 implements AuthResultHandler {
            C02981() {
            }
        ...
        public void onAuthStateChanged(AuthData data) {
            ...
            if (data == null) {
                FirebaseDB.this.myFirebase.authWithCustomToken(FirebaseDB.this.firebaseToken, new C02981());
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.FirebaseDB$6 */
    class C03056 implements ValueEventListener {
        C03056() {
        }
        ...
        public void onDataChange(DataSnapshot data) {
            ...
            if (value instanceof HashMap) {
                listValue = new ArrayList(((HashMap) value).keySet());
            } else if (value instanceof ArrayList) {
                listValue = new ArrayList();
                for (int i = 0; i < ((ArrayList) value).size(); i++) {
                    if (((ArrayList) value).get(i) != null) {
                        listValue.add(Integer.valueOf(i));
                    }
                }
            }
            if (listValue != null) {
                final ArrayList finalListValue = listValue;
                FirebaseDB.this.androidUIHandler.post(new Runnable() {
                    public void run() {
                        FirebaseDB.this.TagList(finalListValue);
                    }
                });
            }
        }
    ...
    private void setupChildListener() {
        this.childListener = new C02971();
    }

    private void setupAuthListener() {
        this.authListener = new C02992();
    }
    ...
    public void GetTagList() {
        this.myFirebase.child("").addListenerForSingleValueEvent(new C03056());
    }
        ...
        firebase.runTransaction(new Transaction.Handler() {
            ...
            public void onComplete(final FirebaseError firebaseError, boolean committed, DataSnapshot currentData) {
                if (firebaseError != null) {
                    ...
                    FirebaseDB.this.androidUIHandler.post(new C03072());
