...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C06352 implements AsyncCallbackPair<JSONObject> {
        ...
        public void onSuccess(JSONObject result) {
            if (result == null) {
                Voting.this.androidUIHandler.post(new C04421());
                return;
            }
            try {
                ...
                if (Voting.this.isPolling.booleanValue()) {
                    ...
                    Voting.this.androidUIHandler.post(new C04432());
                    return;
                }
                Voting.this.androidUIHandler.post(new C04443());
            } catch (JSONException e) {
                Voting.this.androidUIHandler.post(new C04454());
            }
        }
    ...
    class C06364 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            Voting.this.androidUIHandler.post(new C04481());
        }
    ...
    public void RequestBallot() {
        AsynchUtil.runAsynchronously(new C04411());
    }

    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C06352());
    }
    ...
    public void SendBallot() {
        AsynchUtil.runAsynchronously(new C04473());
    }

    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C06364();
