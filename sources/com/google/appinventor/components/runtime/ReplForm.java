...
public class ReplForm extends Form {
    ...
    class C03812 implements OnMenuItemClickListener {
        C03812() {
        }
    ...
    class C03823 implements OnMenuItemClickListener {
        C03823() {
        }
    ...
    public void addSettingsButton(Menu menu) {
        menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new C03812()).setIcon(17301651);
    }

    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new C03823()).setIcon(17301642);
        }
    }
