...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C04336 implements Runnable {
        ...
        class C04321 implements Runnable {
            ...
            public void run() {
                ...
                for (Status status : C04336.this.replies) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C04321());
            }
        }
    }
    ...
    class C04357 implements Runnable {
        ...
        class C04341 implements Runnable {
            ...
            public void run() {
                ...
                for (User user : C04357.this.friends) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.form.dispatchErrorOccurredEvent(Twitter.this, "RequestFollowers", 308, e.getMessage());
            } finally {
                Twitter.this.handler.post(new C04341());
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.Twitter$8 */
    class C04378 implements Runnable {
        ...
        class C04361 implements Runnable {
            ...
            public void run() {
                ...
                for (DirectMessage message : C04378.this.messages) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C04361());
            }
        }
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C04211());
                    return;
                }
                try {
                    ...
                    Twitter.this.handler.post(new C04222());
                }
            }
        });
    }
    ...
    public void CheckAuthorized() {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C04261());
                }
            }
        });
    }
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Twitter.this.handler.post(new C04281());
                        } catch (TwitterException e) {
    ...
    public void RequestMentions() {
        ...
        AsynchUtil.runAsynchronously(new C04336());
    }
    ...
    public void RequestFollowers() {
        ...
        AsynchUtil.runAsynchronously(new C04357());
    }
    ...
    public void RequestDirectMessages() {
        ...
        AsynchUtil.runAsynchronously(new C04378());
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C04231());
                }
            }
        });
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C04241());
                }
            }
        });
    }
